...
const NotificationDropdown = () => {
	return (
		<Menu as="div" className="relative inline-block text-left">
			<div>
				<Menu.Button className="flex m-1 p-2 items-center bg-gray-200 text-[#333333] rounded-full hover:text-red-500 hover:bg-red-200 active:text-red-500 active:bg-red-200">
					<HiBell size={24}/>
					<span className="sr-only">Notifications</span>
					<div className="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-current rounded-full -top-1 -right-1">
						1
					</div>
				</Menu.Button>
			</div>
