    ...
    return (
        <Link href={`/teams/${slug}`}>
            <div className="group flex h-[200px] flex-col overflow-hidden rounded-[5px] border border-neutral-200 text-neutral-900">
                <div className="break-words bg-primary-200 p-2 text-center text-sm font-semibold group-hover:text-primary-base">
                    {name}
                </div>
                <div className="flex h-full flex-col items-center justify-between p-4">
                    <p className="break-words px-4 text-xs line-clamp-3">{description}</p>
